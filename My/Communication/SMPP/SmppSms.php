 ...
 */
class My_Communication_SMPP_SmppSms extends My_Communication_SMPP_SmppPdu
{
	public $service_type;
	public $source;
	public $destination;
	 ...
	 */
	public function __construct($id, $status, $sequence, $body, $service_type, My_Communication_SMPP_SmppAddress $source, My_Communication_SMPP_SmppAddress $destination,
