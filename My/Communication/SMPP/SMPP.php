...
class My_Communication_SMPP_SMPP extends My_Communication_SMPP
{
	...
	{
		switch ($statuscode) {
			case My_Communication_SMPP_SMPP::ESME_ROK: return 'No Error';
			case My_Communication_SMPP_SMPP::ESME_RINVMSGLEN: return 'Message Length is invalid';
			case My_Communication_SMPP_SMPP::ESME_RINVCMDLEN: return 'Command Length is invalid';
			case My_Communication_SMPP_SMPP::ESME_RINVCMDID: return 'Invalid Command ID';
			case My_Communication_SMPP_SMPP::ESME_RINVBNDSTS: return 'Incorrect BIND Status for given command';
			case My_Communication_SMPP_SMPP::ESME_RALYBND: return 'ESME Already in Bound State';
			case My_Communication_SMPP_SMPP::ESME_RINVPRTFLG: return 'Invalid Priority Flag';
			case My_Communication_SMPP_SMPP::ESME_RINVREGDLVFLG: return 'Invalid Registered Delivery Flag';
			case My_Communication_SMPP_SMPP::ESME_RSYSERR: return 'System Error';
			case My_Communication_SMPP_SMPP::ESME_RINVSRCADR: return 'Invalid Source Address';
			case My_Communication_SMPP_SMPP::ESME_RINVDSTADR: return 'Invalid Dest Addr';
			case My_Communication_SMPP_SMPP::ESME_RINVMSGID: return 'Message ID is invalid';
			case My_Communication_SMPP_SMPP::ESME_RBINDFAIL: return 'Bind Failed';
			case My_Communication_SMPP_SMPP::ESME_RINVPASWD: return 'Invalid Password';
			case My_Communication_SMPP_SMPP::ESME_RINVSYSID: return 'Invalid System ID';
			case My_Communication_SMPP_SMPP::ESME_RCANCELFAIL: return 'Cancel SM Failed';
			case My_Communication_SMPP_SMPP::ESME_RREPLACEFAIL: return 'Replace SM Failed';
			case My_Communication_SMPP_SMPP::ESME_RMSGQFUL: return 'Message Queue Full';
			case My_Communication_SMPP_SMPP::ESME_RINVSERTYP: return 'Invalid Service Type';
			case My_Communication_SMPP_SMPP::ESME_RINVNUMDESTS: return 'Invalid number of destinations';
			case My_Communication_SMPP_SMPP::ESME_RINVDLNAME: return 'Invalid Distribution List name';
			case My_Communication_SMPP_SMPP::ESME_RINVDESTFLAG: return 'Destination flag (submit_multi)';
			case My_Communication_SMPP_SMPP::ESME_RINVSUBREP: return 'Invalid ‘submit with replace’ request (i.e. submit_sm with replace_if_present_flag set)';
			case My_Communication_SMPP_SMPP::ESME_RINVESMSUBMIT: return 'Invalid esm_SUBMIT field data';
			case My_Communication_SMPP_SMPP::ESME_RCNTSUBDL: return 'Cannot Submit to Distribution List';
			case My_Communication_SMPP_SMPP::ESME_RSUBMITFAIL: return 'submit_sm or submit_multi failed';
			case My_Communication_SMPP_SMPP::ESME_RINVSRCTON: return 'Invalid Source address TON';
			case My_Communication_SMPP_SMPP::ESME_RINVSRCNPI: return 'Invalid Source address NPI';
			case My_Communication_SMPP_SMPP::ESME_RINVDSTTON: return 'Invalid Destination address TON';
			case My_Communication_SMPP_SMPP::ESME_RINVDSTNPI: return 'Invalid Destination address NPI';
			case My_Communication_SMPP_SMPP::ESME_RINVSYSTYP: return 'Invalid system_type field';
			case My_Communication_SMPP_SMPP::ESME_RINVREPFLAG: return 'Invalid replace_if_present flag';
			case My_Communication_SMPP_SMPP::ESME_RINVNUMMSGS: return 'Invalid number of messages';
			case My_Communication_SMPP_SMPP::ESME_RTHROTTLED: return 'Throttling error (ESME has exceeded allowed message limits)';
			case My_Communication_SMPP_SMPP::ESME_RINVSCHED: return 'Invalid Scheduled Delivery Time';
			case My_Communication_SMPP_SMPP::ESME_RINVEXPIRY: return 'Invalid message (Expiry time)';
			case My_Communication_SMPP_SMPP::ESME_RINVDFTMSGID: return 'Predefined Message Invalid or Not Found';
			case My_Communication_SMPP_SMPP::ESME_RX_T_APPN: return 'ESME Receiver Temporary App Error Code';
			case My_Communication_SMPP_SMPP::ESME_RX_P_APPN: return 'ESME Receiver Permanent App Error Code';
			case My_Communication_SMPP_SMPP::ESME_RX_R_APPN: return 'ESME Receiver Reject Message Error Code';
			case My_Communication_SMPP_SMPP::ESME_RQUERYFAIL: return 'query_sm request failed';
			case My_Communication_SMPP_SMPP::ESME_RINVOPTPARSTREAM: return 'Error in the optional part of the PDU Body.';
			case My_Communication_SMPP_SMPP::ESME_ROPTPARNOTALLWD: return 'Optional Parameter not allowed';
			case My_Communication_SMPP_SMPP::ESME_RINVPARLEN: return 'Invalid Parameter Length.';
			case My_Communication_SMPP_SMPP::ESME_RMISSINGOPTPARAM: return 'Expected Optional Parameter missing';
			case My_Communication_SMPP_SMPP::ESME_RINVOPTPARAMVAL: return 'Invalid Optional Parameter Value';
			case My_Communication_SMPP_SMPP::ESME_RDELIVERYFAILURE: return 'Delivery Failure (data_sm_resp)';
			case My_Communication_SMPP_SMPP::ESME_RUNKNOWNERR: return 'Unknown Error';
			default:
